...
```{r distribution of MAE histogram}
cvReg.sp$resample %>% 
...
Looking at the mean abssolute percentage error of the tracts in Philadelphia, we actually see that while there are many areas with
...
mapePlot %>% 
  ggplot() + 
      ...
      scale_fill_manual(values = c("< -1" = "#7b3294",
                                "-1 - -0.25" = "#c2a5cf",
                                "-0.25 - 0.25" = "#f7f7f7",
                                "0.25 - 1" = "#a6dba0",
                                "1 <" = "#008837"), name = "MAPE") +
...
Finally, for a generalization check, we are looking at the social minority and majority in Philadelphia. Despite the fact that the model yields a 29% for social majority tracts and 42% for social minority tracts, the model is unfortunately unable to provide highly general results for neither social majority nor minority tracts. 
